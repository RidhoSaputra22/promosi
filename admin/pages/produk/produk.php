            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td><img src="../assets/img/produk/<?= $data['foto'] ?>" width="100px" height="50px"></td>
                        <td><?= $data['hp'] ?></td>


                        <td>
                            <!-- EDIT BTN -->
                            <button type="button" id="edit-btn" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#edit-modal" data-nama="<?= $data['nama'] ?>" data-foto="<?= $data['foto'] ?>" data-hp="<?= $data['hp'] ?>" data-deskripsi="<?= $data['deskripsi'] ?>" data-id="<?= $data['id_produk'] ?>">
                ...
                <div class="modal-body ">
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <input type="text" class="form-control" id="tdeskripsi" value="">
                        </div>
                    </div>
                    <div class="col ">
                        <label for="" class="mt-">No. Hp</label>
                        <input type="number" class="form-control" id="thp" value="">
                    </div>
            ...
            <form method="post" enctype="multipart/form-data">
                <div class="modal-body ">
                    <div class="row">
                        ...
                        <div class="col">
                            <label for="" class="mt- ">No. Hp</label>
                            <input type="number" class="form-control" id="uhp" value="">
                        </div>
                        <p for="" class="mt-3">Foto</p>
